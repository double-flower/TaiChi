...
morohutils.o: morohutils.cu
	$(CUDA_CC) -ccbin g++ $(NVCC_FLAGS) -o morohutils.o -c morohutils.cu $(CUDA_INCLUDES) $(OPENCV_INCLUDES)
mmio.o: mmio.cpp
	$(CUDA_CC) -ccbin g++ $(NVCC_FLAGS) -o mmio.o -c mmio.cpp $(CUDA_INCLUDES) 
spmv: TaiChi.o main.o morohutils.o mmio.o
	$(CUDA_CC) $(NVCC_FLAGS) TaiChi.o main.o morohutils.o mmio.o -o spmv $(CUDA_INCLUDES) $(CUDA_LIBS) $(OPENCV_LIBS)
clean:
	rm *.o 
